package com.lots.lots.dao.dao;

import com.baomidou.mybatisplus.core.mapper.BaseMapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.ydw.open.model.db.TbDeviceBase;
...
public interface TbDevicesMapper extends BaseMapper<TbDevices> {
    ...
    Page<DeviceVO> getDevicesList(@Param("id") String id, @Param("name") String name, @Param("innerMac") String innerMac, @Param("clusterName") String clusterName,
                                  @Param("idc") String idc, @Param("cabinet") String cabinet,
                                  @Param("location") String location, @Param("slot") String slot, @Param("groupName") String groupName,
                                  @Param("managerIp") String managerIp, @Param("managerPort") Integer managerPort, @Param("innerIp") String innerIp,
                                  @Param("innerPort") Integer innerPort,
                                  @Param("ip") String ip, @Param("port") Integer port, @Param("description") String description,
                                  @Param("schStatus") Integer schStatus, @Param("status") String status, @Param("baseType") Integer baseType,
                                  @Param("search") String search, @Param("identification") String identification, Page buildPage);

    List<DeviceStatusCountVO> getDeviceStatusCount(@Param("clusterId") String clusterId,@Param("identification") String identification);

    Page<DeviceUsageCountVO> getDeviceUsageRate(@Param("clusterId") String clusterId, @Param("identification") String identification,Page buildPage);

    Page<DeviceUsageCountHistoryVO> getDeviceUsageHistory(@Param("startTime") String startTime, @Param("endTime") String endTime,
                                                          @Param("clusterId") String clusterId, @Param("day") long day,@Param("identification") String identification, Page buildPage);
    ...
    String getTotalUsage(@Param("startTime") String startTime, @Param("endTime") String endTime, @Param("day") long day, @Param("identification") String identification);
    ...
    Page<NetBarDeviceVO> getNetBarDevices(@Param("clusterId") String clusterId ,Page buildPage);
}
