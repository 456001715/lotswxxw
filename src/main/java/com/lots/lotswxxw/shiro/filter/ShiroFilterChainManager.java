package com.lots.lotswxxw.shiro.filter;


import com.lots.lotswxxw.service.AccountService;
import com.lots.lotswxxw.shiro.config.RestPathMatchingFilterChainResolver;
import com.lots.lotswxxw.shiro.provider.ShiroFilterRulesProvider;
import com.lots.lotswxxw.shiro.rule.RolePermRule;
import com.lots.lotswxxw.support.SpringContextHolder;
...
public class ShiroFilterChainManager {
    ...
    public Map<String,String> initGetFilterChain() {
        ...
        // -------------anon 默认过滤器忽略的URL
        List<String> defalutAnon = Arrays.asList("/css/**","/js/**","/static/**","/assets/**","/images/**","/user-head/**");
