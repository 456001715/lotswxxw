...
public class ServletUtils {
    ...
    public static Map<String, String> getHeaderMap(HttpServletRequest request) {
        final Map<String, String> headerMap = new HashMap<>(20);
    ...
    public static void setHeader(HttpServletResponse response, String name, Object value) {
        ...
        } else if (value instanceof Integer || intString.equalsIgnoreCase(value.getClass().getSimpleName())) {
