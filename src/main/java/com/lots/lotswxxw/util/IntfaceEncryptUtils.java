...
public class IntfaceEncryptUtils {
    ...
    /**默认加密秘钥，必须16位*/
    private static final String DEFAULT_KEY = "a2s1xsd12a@!xssf";
    ...
    public static void main(String[] args) {
        ...
        //加密
        try {
            String result= encryptByDefaultKey(b);
            System.out.println(result);
            //解密
            System.out.println(decryptByDefaultKey("cqtCzXYb+IStYSupVq8FunebIOj0f2fclzkGyIUIkdBdjWUlAoyAbrtAnR+8ynDVBJzMz3EETm4Cd4ynXOrPkFUIC1U/Nt28aD4V85wZE0P64nmzsD3rzV2Fyvs+Vpruslxp5BIXJkIpEbyHsXwbErjIWjd+TnTv/AG9zDWkRE6+xsMvOcHjxrA+NNE2dI9U5FDLZS2qLxs5BKbDvYGw0g=="));
        }catch (Exception e) {
            e.printStackTrace();
        }
