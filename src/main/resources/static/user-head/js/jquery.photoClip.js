...
(function(root, factory) {
	...
	if (typeof define === "function" && define.amd) {
		define(["jquery", "static/user-head/js/iscroll-zoom", "hammer"], factory);
	} else if (typeof exports === "object") {
		module.exports = factory(require("jquery"), require("static/user-head/js/iscroll-zoom"), require("static/user-head/js/hammer"));
	} else {
